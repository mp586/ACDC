...
def convert_units(ds):
    ...
    if 'flux_lhe' in ds.data_vars:
        ds['flux_lhe'].values = 1/28 * ds['flux_lhe'].values
        ds['flux_lhe'].attrs['units']='mm/day'

    # bucket depth cond,conv,lh m/s to mm/day
    if 'bucket_depth_cond' in ds.data_vars:
        # Assume these all go together ...
