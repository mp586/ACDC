...
plotting_routines_kav7.any_configuration_plot(-90.,90.,bucket_depth_avg.where(landmask==1.),area_array,'m','bucket_depth','fromwhite',landmaskxr,landlats,landlons,minval=0.,maxval=.1)
# if runmin == 1:
...
plotting_routines_kav7.any_configuration_plot(-90.,90.,precipitation_month_avg.sel(month=1),area_array,'mm/day','P_January (mm/day)','fromwhite',landmaskxr,landlats,landlons,nmb_contours=4)
